...
**Version 4.5.0-dev.6 (2021/09/05)**

* **New Features**
	* None.
* **Improvements**
	* Minor optimization for stable version data from wordpress.org.
* **Bugfixes**
	* None.
* **Developer Notes**
	* None.
...
(2021/09/05) Minor optimization for stable version data from wordpress.org.
